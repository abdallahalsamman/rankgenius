<div>
    <x-header size="text-xl font-[700]" subtitle="Browse through all articles that you've generated so far." title="Articles" />
    ...
    <div class="grid grid-cols-[_1fr_6fr_1fr] gap-3 border-b-[1px] px-3">
        ...
        <div class="py-2 text-center text-xs font-bold tracking-wider text-gray-600">
            TITLE</div>
        <div class="py-2 text-right text-xs font-bold tracking-wider text-gray-600">
            ACTIONS</div>
    </div>
